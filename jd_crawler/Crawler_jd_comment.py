...
class JDCommentsCrawler:
    ...
    def crawler(self,pid):
        ...
        final_df.to_csv(path_or_buf='./comment/jdcomment_%d.csv' % pid, encoding='gbk')


def jdComment(pid = 100032149194):
    # 设置关键变量
    page = 3  # 页数
    # productId = 6474492  # 商品ID
    # productId = 100032149194
    callback = 'fetchJSON_comment98vv782'  # 回调函数
    JDC = JDCommentsCrawler(pid, callback, page)
    JDC.concatLinkParam()
    JDC.crawler(pid)
